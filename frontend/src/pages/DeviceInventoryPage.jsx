  ...
  const sortedDevices = useMemo(() => {
    return [...devices].sort((a, b) => {
      switch (sortOption) {
        ...
        case "imported-oldest":
          return new Date(a.importedAt || 0) - new Date(b.importedAt || 0);
        case "status-risk":
...
<<<<<<< HEAD
        <select value={sortOption} onChange={(e) => setSortOption(e.target.value)} aria-label="Sắp xếp thiết bị">
          ...
          <option value="name-asc">Tên thiết bị A-Z</option>
          <option value="room-asc">Phòng A-Z</option>
          <option value="imported-newest">Ngày nhập mới nhất</option>
